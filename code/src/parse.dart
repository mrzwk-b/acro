...
//   /// parses the longest possible expression
//   /// 
...
//     // numbers
//     else if (int.tryParse(text[0]) != null) {
//       String value = '';
...
//     trim();
//     if (parenthesized && text.startsWith(')')) {
//       text = text.substring(1);
//       trim();
//       parenthesized = false;
//     }
...
//     trim();
//     if (parenthesized) {
//       assert(text.startsWith(')'), "Expected closing paren, found '${text[0]}'");
//       text = text.substring(1);
//     }
...
//       text = text.substring(1);
//       trim();
//       statement = Jump(parseExpression());
//     }
//     else if (text[0] == 'O') {
//       text = text.substring(1);
//       trim(); 
